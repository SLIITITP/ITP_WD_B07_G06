                ...
                <tbody>
                    {appointments.map((appointments,index) => (
                        <tr key={index}>
                            ...
                            <td>
                                <Link to={`/update/${appointments._id}`} className="btn btn-sm btn-update">Update</Link>
                                <Link to={`/delete/${appointments._id}`} className="btn btn-sm ms-1 btn-delete">Delete</Link>
                            </td>
                        </tr>
                    ))}
                </tbody>
