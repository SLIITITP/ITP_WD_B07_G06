                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="form-group form-group-q">
                                ...
                                <input type="text" name="name" id="question" placeholder="Enter the question" className="form-control form-control-q" onChange={
                                    (e)=>{
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="form-group">
                                ...
                                <select id="answertype" name="role" className="form-control form-control-q" onChange={
                                    (e)=>{
                        ...
                        <p id="tfmsg"className="text-danger d-none">Points for the answer True : 10 and False : 0</p> 
                    </div>
                    <div  id="atypemc" className="row  text-center d-none">
                            <div className="col-8 text-center">
                                <div className="form-group form-group-q">
                                    <label id="name-label" for="name">Add Your Answers</label>
                                    ...
                                    <div key={idx} className="row">
                                        <div className="col-10">
                                            <div className="row">
                                                <div className="col-8">
                                                <input type="text" id="name" placeholder={'Add Answers One By One'} 
                                        ...
                                        <div className="col-3">
                                         {idx > 0 && (
                                        <button type="button" className="btn  btn-q btn-ptimary-q btn-block btn-danger-q"
                                    ...
                                    <div className="">
                                        ...
                                        <button type="button"onClick={handleAddInput}className="btn btn-primary btn-q btn-primary-q btn-block ">Add +</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    <div id="atypeRange" className="row d-none">
                    <p className="text-danger">Points for the answer will get as selecting the range</p> 
                        <div className="col-5">
                            <div className="form-group form-group-q">
                                <label id="name-label" for="name">Start Point</label>
                                <input type="text" name="startPoint" id="name" onChange={
                                      (e)=>{
                                        setStartPoint(e.target.value);
                                    }}
                                 placeholder="Input &lt; End Point" className="form-control form-control-q" required/>
                            </div>
                        </div>
                        <div className="col-5">
                            <div className="form-group form-group-q">
                                <label id="name-label" for="name">End Point</label>
                                <input type="text" name="endPoint" id="name" 
                                onChange={
                                    (e)=>{
                                      setEndPoint(e.target.value);
                                  }} placeholder="Input &gt; Start Point" className="form-control form-control-q" required/>
                            </div>
                        </div>
                    </div>
                    <div className="row text-center">
                        <div className="col-12">
                            <button type="submit" id="submit" className="btn btn-primary btn-q btn-primary-q btn-block"onClick={setData}>Submit Question</button>
                        </div>
                    </div>
